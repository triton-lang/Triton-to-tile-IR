...
import re
from triton._internal_testing import is_cuda, is_hip, is_hip_cdna3, is_hip_cdna4, is_hip_cdna, is_hip_gfx1250, is_tileir
...
def test_mxfp(BLOCK_M, BLOCK_N, BLOCK_K, NUM_STAGES, nonKDim, NUM_WARPS, device):
    ...
    if is_tileir():
        pytest.skip("skip for CUDA Tile IR (tileir), tt.dot_scaled")
...
@pytest.mark.skipif(is_tileir(), reason="CUDA Tile IR (tileir) backend doesn't support dot_scale at CUDA 13.1")
