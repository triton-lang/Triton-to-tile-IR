...
def supports_block_scaling():
    return ((is_cuda() or is_tileir()) and torch.cuda.get_device_capability()[0] in [10, 11]) or is_hip_cdna4()


if (is_cuda() or is_tileir()) and torch.cuda.get_device_capability()[0] in [10, 11]:
