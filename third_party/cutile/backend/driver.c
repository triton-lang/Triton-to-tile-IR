...
static PyObject *loadCutileBinary(PyObject *self, PyObject *args) {
  const char *name;
  const char *data;
...
static PyMethodDef ModuleMethods[] = {
    {"load_cutile_binary", loadCutileBinary, METH_VARARGS,
     "Load provided cutile into CUDA driver"},
    {NULL, NULL, 0, NULL} // sentinel
};

static struct PyModuleDef ModuleDef = {PyModuleDef_HEAD_INIT, "cutile_utils",
                                       NULL, // documentation
                                       -1,   // size
                                       ModuleMethods};

PyMODINIT_FUNC PyInit_cutile_utils(void) {
