...
- triton_tileir wheel from the [release page](https://github.com/triton-lang/Triton-to-tile-IR/releases)
  - `triton_tileir-3.7.1+tileir13.4.0-cp312-cp312-linux_x86_64.whl` for Python 3.12
...
pip install --no-cache-dir --no-deps --target $TRITON_TILEIR_DIR ./triton_tileir-3.7.1+tileir13.4.0-cp312-cp312-linux_x86_64.whl
```
...
COPY triton_tileir-3.7.1+tileir13.4.0-cp312-cp312-linux_x86_64.whl /tmp/
RUN pip install --no-cache-dir --no-deps --target /opt/triton_tileir /tmp/triton_tileir-3.7.1+tileir13.4.0-cp312-cp312-linux_x86_64.whl \
    && rm /tmp/triton_tileir-3.7.1+tileir13.4.0-cp312-cp312-linux_x86_64.whl
```
