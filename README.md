...
**The default backend is OSS PTX. This source branch uses Triton 3.6.0 and CUDA Tile IR 13.4. Using [Helion](https://github.com/pytorch/helion) with the TileIR backend ([wheels](https://github.com/triton-lang/Triton-to-tile-IR/releases))?** Check out the **[Helion TileIR Backend Performance Tuning Guide](HelionPerformanceTuningGuide.md)** for config recipes, autotuning strategies, and porting tips.
...
- Legacy block pointers (deprecated upstream; retained on this Triton release line).
